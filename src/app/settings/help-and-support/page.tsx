...
// Accessing FAQ data
console.log(faqData[0].question); // Outputs: "What is JavaScript?"
console.log(faqData[0].answer); // Outputs: "JavaScript is a versatile programming language commonly used for web development..."
